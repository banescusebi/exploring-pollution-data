...
## to show the trend of emissions over the period from 1999-2008.
qplot(year, log10(Emissions), 
      data = vehicle_related_sources_in_Baltimore_and_LA, facets = .~fips) +
  geom_smooth(method = "lm", na.rm = TRUE) +
  labs(title = "Motor vehicle related emissions and trend between 1999-2008")
